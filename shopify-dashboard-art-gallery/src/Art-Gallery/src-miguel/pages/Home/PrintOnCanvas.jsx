...
const LatestCollection = () => {
  ...
  const array2 = [im5,im2,im3,im4,im5,im6,im7,im8,im9,im10,im11,im12,im13,im14,im15,im16,im17,im18,im19,im20,im21,im22,im23];
  const PrintOnCanvas = () => {
    ...
    return (
      <section className='flex justify-end'>
        ...
        <div className="flex justify-around">
          <h2 className="leading-10 py-12 px-5 md:text-3xl font-bold text-[#F6C936]">Print On Canvas By Category</h2>
